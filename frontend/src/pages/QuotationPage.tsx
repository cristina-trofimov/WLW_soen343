...
const handleInputChange = (field: keyof qFormData, value: any) => {
  ...
  return (
   ...
   {qFormData.distance && (
      <>
        ...
        <div>
          <p>Shipping Dates</p>
          <p>Regular Shipping: ${qFormData.shippingPrices.regular} (delivers: {qFormData.deliveryDate.regular})</p>
          <p>Express Shipping: ${qFormData.shippingPrices.express} (delivers: {qFormData.deliveryDate.express})</p>
          <p>Eco Shipping: ${qFormData.shippingPrices.eco} (delivers: {qFormData.deliveryDate.eco})</p>
  </div>
      </>
)}
</Container>
